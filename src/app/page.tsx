...
export default function HomePage() {
  ...
  // ⬇️ NEW: always sync state FROM the URL when search params change (handles iOS back/forward & soft nav)
  useEffect(() => {
  ...
  }, [sp]) // intentionally not depending on state; we compare before setting
